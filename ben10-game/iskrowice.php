...
require_once('menu.php');
    ...
    echo  '<h2><center>Walka z MegaWhattem</center></h2>';
	...
	foreach($NPC as $id => $r)
            {
                ...
                {
	echo "<center><hr/><p>
Już teraz możesz udać się do miasteczka Iskrowice, gdzie Megawhatty szaleją i bawią się w najlepsze.<br/>
...
<tr></tr>
<tr></tr>
<td><img src='obrazki/iskrowice.png' alt=''/></td>
    <td><center>Iskrowice:
	<hr/>";
echo '<a href="iskrowice.php?id='.$id.'">Wyrusz tam !</a></li>';
echo "</table></center>
        ...
        $oponent = & $NPC[$_GET['id']];
            	...
            	if($uzytkownik['akcje'] < 10){
            		...
            		if(true) {
            			...
            			echo "<p class='note'>Podczas swojej podrózy napotkałeś <b>".$oponent['name']."</b>. Do walki stanie jeden z <b>".$monster['name']."</b> </p><br class='clear'>
            			...
            			if($wynik == 1){
            				...
            				mysql_query("update pokemon_gracze set zabitemegawhatty = zabitemegawhatty + 1 where gracz = ".$uzytkownik['gracz']);
            				...
            				echo "
            				<p class='note'>
            					Po przegranej walce z  <b>".$monster['name']."</b> opuszczasz pole bitwy  i patrzysz się jak Megawhatty nadal robią psikusy innym.
            				</p><br class='clear'>";
