...
<tr></tr>
<tr></tr>
<td><img src='obrazki/lasm.png' alt=''/></td>
    <td><center>Las Małych Robotów:
	<hr/>";
echo '<a href="mrobot.php?id='.$id.'">Wyrusz tam !</a></li>';
echo "</table></center>
            	...
            	if($uzytkownik['akcje'] < 10){
            		...
            		if(true) {
            			...
            			if($wynik == 1){
            				...
            				mysql_query("update pokemon_gracze set zabitemaleroboty = zabitemaleroboty + 1 where gracz = ".$uzytkownik['gracz']);
            				...
            				echo "
            				<p class='note'>
            					Po przegranej walce z  <b>".$monster['name']."</b> opuszczasz pole bitwy  i patrzysz się jak Robot nadal wszystko rujnuje
            				</p><br class='clear'>";
