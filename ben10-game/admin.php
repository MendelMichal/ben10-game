...
if($uzytkownik['login'] != 'admin') echo "brak dostępu";
	...
	switch($_GET['act']){
		...
		case 'vip5': require_once('admin/vip5.php'); break;
		case 'cron': require_once('cron/cron-00.php'); break;
		default:
			echo "
				<ul>
					...
					<li><a href='admin.php?act=vip5'>dodaj kody VIP5</a>
					<li><a href='admin.php?act=cron'>Cron</a>
				</ul>
			";
		break;
	}
