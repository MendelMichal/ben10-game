...
$NPC = array(
            array(
                'name' => 'Jonah Melville i jego ekipa', 
...
require_once('menu.php');
    ...
    echo  '<h2><center>Walka z Jonah Melville i jego ekipą</center></h2>';
	...
	foreach($NPC as $id => $r)
            {
                ...
                {
	echo "<center><hr/><p>
Już teraz możesz udać się nad wodę, aby poszukać ekipy Jonah Melville'a<br/>
...
<tr></tr>
<tr></tr>
<td><img src='postacie/jonah.png' alt=''/></td>
    <td><center>Jezioro Krakkena:
	<hr/>";
echo '<a href="jonah.php?id='.$id.'">Wyrusz tam !</a></li>';
echo "</table></center>
        ...
        $oponent = & $NPC[$_GET['id']];
            	...
            	if($uzytkownik['akcje'] < 10){
            		...
            		if(true) {
            			...
            			echo "<p class='note'>Podczas swojej podrózy napotkałeś <b>".$oponent['name']."</b>. Do walki stanął sam <b>".$monster['name']."</b> </p><br class='clear'>
            			...
            			if($wynik == 1){
            				...
            				mysql_query("update pokemon_gracze set zabitejonah = zabitejonah + 1 where gracz = ".$uzytkownik['gracz']);
            				...
            				echo "
            				<p class='note'>
            					Po przegranej walce z  <b>".$monster['name']."</b> opuszczasz pole bitwy  i patrzysz się jak Jonah Melville i jego ekipa nadal okradają jaja.
            				</p><br class='clear'>";
