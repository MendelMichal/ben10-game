...
$NPC = array(
            array(
                'name' => 'Specjalne Roboty Vilgaxa', 
                'lvl' => array(1, 100000000), 
                'heroes' => array(
                    array(
                        'name' => 'Duży Robot Vilgaxa', 
                        'attack' => 4, 'defense' => 5, 
                        'dmg' => array(5, 7), 
                        'hp' => 35, 'img' => 101, 
                        'points' => 80
...
require_once('menu.php');
    ...
    echo  '<h2><center>Walka z Robotem</center></h2>';
	...
	foreach($NPC as $id => $r)
            {
                ...
                {
	echo "<center><hr/><p>
Już teraz możesz udać się do lasu, gdzie aż roi się od robotów Vilgaxa<br/>
...
<tr></tr>
<tr></tr>
<td><img src='obrazki/lasd.png' alt=''/></td>
    <td><center>Las Dużych Robotów:
	<hr/>";
echo '<a href="drobot.php?id='.$id.'">Wyrusz tam !</a></li>';
echo "</table></center>
        ...
        $oponent = & $NPC[$_GET['id']];
            	...
            	if($uzytkownik['akcje'] < 10){
            		...
            		if(true) {
            			...
            			echo "<p class='note'>Podczas swojej podrózy napotkałeś <b>".$oponent['name']."</b>. Do walki stanął <b>".$monster['name']."</b> </p><br class='clear'>
            			...
            			if($wynik == 1){
            				...
            				mysql_query("update pokemon_gracze set zabiteduzeroboty = zabiteduzeroboty + 1 where gracz = ".$uzytkownik['gracz']);
            				...
            				echo "
            				<p class='note'>
            					Po przegranej walce z  <b>".$monster['name']."</b> opuszczasz pole bitwy  i patrzysz się jak Duże Roboty nadal wszystko rujnują
            				</p><br class='clear'>";
